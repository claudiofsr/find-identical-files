...
complete -c find_duplicate_files -s c -l csv_dir -d 'Set the output directory for the CSV file (fdf.csv)' -r -F
...
complete -c find_duplicate_files -s w -l wipe_terminal -d 'Wipe (Clear) the terminal screen before listing the duplicate files'
