...
'-a+[Choose the hash algorithm]:ALGORITHM:(ahash blake3 fxhash foldhash sha256 sha512)' \
'--algorithm=[Choose the hash algorithm]:ALGORITHM:(ahash blake3 fxhash foldhash sha256 sha512)' \
